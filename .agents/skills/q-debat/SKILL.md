...
Het werkdossier op schijf is het gedeelde geheugen. Subagents zijn stateless en lezen telkens het hele werkdossier voordat ze schrijven.
...
2. Kopieer templates:
   - `templates/werkdossier-template.md` naar `werkdossier.md`
...
3. Geef elke opponent:
   - absoluut pad naar `werkdossier.md`
...
4. Roep de moderator aan met paden naar `werkdossier.md`, `state.json`, `sources.md`, de reference-bestanden, het rondenummer en de instructie: dit is een ronde-evaluatie.
...
2. Roep `q-moderator` aan met de opdracht `Schrijf het EINDRAPPORT` en paden naar `werkdossier.md`, `state.json`, `sources.md` en de run-map.
3. Lees `eindrapport.md` en geef de gebruiker een bondige samenvatting: eindscore, stopreden, scoreverloop en paden naar `werkdossier.md` en `eindrapport.md`.
