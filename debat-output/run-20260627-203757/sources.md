...
- **Mattes 22:7; Lucas 19:43-44; 21:20** — synoptische vaticinia ex eventu als vergelijkingspunt. Ronde 3.
- **Handelingen 5:36-37** (Theudas + Judas de Galileeer) — naast Josephus *Ant.* 20.97-102. Ronde 3.
...
- David Wead en Paul Duke (johanneische ironie, vgl. Sophocles/Thirlwall).
...
- Brian Neil Peterson, Hassell Bullock (Ezechiel-herkenningsformule); Rudolf Bultmann (*Rekognitionsformel*; Offenbarungsreden).
...
- Raymond E. Brown, Urban C. von Wahlde, Otto Betz, John Breck, D. Moody Smith (Paracleet / "Geest der waarheid" en Qumran 1QS). Tegenstem: Leon Morris, Andreas Koestenberger, Richard Bauckham, Riku Tuppurainen.
...
consolatie/symposion, vriendschapstopos, Paracleet / Geest der waarheid en de Israel-wijngaard.

## Toetsstatus in één oogopslag

- **Primair getoetst en bevestigd:** 16 antieke passages via `brontekst` (rij A, met succes opgehaald)
  plus de NT-verzen via biblehub/NA28 (rij B).
- **Niet primair toetsbaar gebleken:** Diodorus Siculus 1.27.4 (404; Isis-argument bleef secundair);
  Qumran 1QS (niet in Sefaria); Tal Ilans naamdataset (niet via `brontekst`).
...
- **Geen `⚠️ onverifieerbaar`-markeringen** door de moderator in enige ronde; één notebook-synthese
  (Israel-wijngaard) zonder auteurstoeschrijving, maar met bevestigde primaire teksten.
